        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="Navbar">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active"><a class="nav-link" href="Home.php"><span class="fa fa-home fa-lg"></span>
                            Home</a></li>
                        ...
                        <div class="card-body">
                            <form method="post" action="../controllers/regInsert.php">
                                <div class="form-group row">
                                    <label for="username" class="col-md-4 col-form-label text-md-right">User
                                        Name</label>
                                    <div class="col-md-6">
                                        <input type="text" id="USERS_NAME" class="form-control" name="USERS_NAME" required autofocus>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="email" class="col-md-4 col-form-label text-md-right">E-Mail
                                        Address</label>
                                    <div class="col-md-6">
                                        <input type="text" id="USERS_EMAIL" class="form-control" name="USERS_EMAIL" required autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="password" id="USERS_PASSWORD" class="form-control" name="USERS_PASSWORD" required>
                                    </div>
                                </div>
